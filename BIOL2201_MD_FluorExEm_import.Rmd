...
#OneDrive paths do not work for Posit.cloud; need to move files from OneDrive to git tracked repository, then access with 'Pull' in Posit.cloud
...
#Local MetaData path does not work on Posit.cloud
...
#Local MetaData, moved from OneDrive to git tracked project, to github, update with 'pull' from GitHub
