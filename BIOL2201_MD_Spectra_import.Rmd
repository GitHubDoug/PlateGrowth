...
ToDo
Type Convert on OD_data
Select multiple wavelengths
Use photobiology colour function to colour according to wavelength
Plot multiple wavelength trajectories on same panels
Export simple 600 nm trajectories for analyses in Excel
Continue multispectral curve fitting in this or another .Rmd.
...
```{r OD facet plot}
OD_long |> ggplot() +
  geom_line(aes(x = E_hours, y = logOD, colour = as.factor(Wavelength_nm)), show.legend = FALSE) + 
